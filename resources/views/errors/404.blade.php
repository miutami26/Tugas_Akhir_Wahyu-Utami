                        ...
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <img src="{{ url('/') }}/assets/images/404.jpg" alt=""
                                    class="d-block mx-auto mt-4" height="250">
                                <div class="text-center auth-logo-text mb-4">
                                    <h4 class="mt-0 mb-3 mt-5">Oops! Halaman yang Anda cari tidak tersedia...</h4>
                                    <p>Maaf, URL yang Anda tuju tidak ditemukan. Silakan periksa kembali URL atau
                                        kembali ke halaman utama.</p>
                                    <a href="{{ url('/') }}" class="btn btn-sm btn-gradient-primary">Kembali ke
                                        Dashboard</a>
